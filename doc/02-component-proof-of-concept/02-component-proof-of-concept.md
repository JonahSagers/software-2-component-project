...
I've chosen Ouiji Board as my favorite of the component options, mostly because it's the coolest.
It also has a clearly defined link between the kernel methods and secondary methods and doesn't rely on any other OSU components.
