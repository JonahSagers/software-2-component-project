...
public class OuijiBoard {
     ...
     * @ensures this = {}
     */
    public OuijiBoard(String spiritValue) {
    ...
    public final void transferFrom(OuijiBoard source) {
        ...
        assert source instanceof OuijiBoard : ""
         ...
         */
        OuijiBoard localSource = (OuijiBoard) source;
    ...
    public static void main(String[] args) {
        ...
        OuijiBoard ouijiBoard = new OuijiBoard();
        char input = ' ';
        while (input != '0') {
